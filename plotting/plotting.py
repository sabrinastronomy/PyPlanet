...
# typ = "adiabatic"
# for temp in [300]:
#     direc_with_phases_constant = f"/Users/sabrinaberger/Library/Mobile Documents/com~apple~CloudDocs/RockyPlanets/paper_data/complete_data_with_silicate_mantle/{temp}_constant_data/"
#     p_c = direc_with_phases_constant + f"p_c_grid_{typ}_{temp}.pyc.npy"
#     p_cmb_percentage = direc_with_phases_constant + f"p_cmb_percentage_grid_{typ}_{temp}.pyc.npy"
#     radius = direc_with_phases_constant + f"radius_grid_{typ}_{temp}.pyc.npy"
#     mass = direc_with_phases_constant + f"mass_grid_{typ}_{temp}.pyc.npy"
#     import numpy as np
#     # radius_lower = diff_direc_with_phases_constant + f"radius_grid_{typ}_{temp_diff}.pyc.npy"
#     PlotBasic(temp, "_adiabatic_", p_c, p_cmb_percentage, radius, mass, radius_lower="", difference=False)
#

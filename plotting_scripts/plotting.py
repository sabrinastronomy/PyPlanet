...
for typ in types:
    for temp in [3000]:
        direc_with_phases = f"/Users/sabrinaberger/complete_data_with_silicate_mantle/{temp}_{typ}_data/"
        diff_direc_with_phases = f"/Users/sabrinaberger/complete_data_with_silicate_mantle/{diff_temp}_constant_data/"
